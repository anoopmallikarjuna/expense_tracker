...
<%@page isELIgnored="false" %>
	...
	<!-- narbar -->
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #00CCFF !important; box-shadow: 0 0 3px 0 rgba(0,0,0,0.3);">
	  <div class="container-fluid">
	    <a class="navbar-brand" href="index.jsp"> <i class="fa-solid fa-indian-rupee-sign"></i>Expense Tracker</a>
